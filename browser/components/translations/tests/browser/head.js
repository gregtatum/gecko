...
class SelectTranslationsTestUtils {
  ...
  static #assertPanelTextAreaDirection(langTag = null) {
    ...
    const actualTextDirection = translatedTextArea.getAttribute("dir");
   ...
   * @param {string | null} [langTag=null] - The optional language tag to assert against.
   */
  static #assertSelectedLanguage(menuList, langTag = null) {
    if (langTag) {
