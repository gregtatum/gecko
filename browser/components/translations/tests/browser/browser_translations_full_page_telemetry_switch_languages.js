...
add_task(async function test_translations_telemetry_switch_from_language() {
  ...
  FullPageTranslationsTestUtils.changeSelectedFromLanguage({ langTag: "en" });
  ...
  FullPageTranslationsTestUtils.changeSelectedFromLanguage({ langTag: "es" });
  ...
  FullPageTranslationsTestUtils.changeSelectedFromLanguage({ langTag: "" });
...
add_task(async function test_translations_telemetry_switch_to_language() {
  ...
  FullPageTranslationsTestUtils.changeSelectedToLanguage({ langTag: "en" });
  ...
  FullPageTranslationsTestUtils.changeSelectedToLanguage({ langTag: "" });
