...
add_task(async function test_about_preferences_manage_languages() {
  ...
  await assertVisibility({
    ...
    visible: { downloadAll, frenchDownload, spanishDownload, ukrainianDownload },
  ...
  await assertVisibility({
    ...
    visible: { downloadAll, deleteAll, frenchDelete, spanishDownload, ukrainianDownload },
