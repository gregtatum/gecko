 ...
 */
add_task(async function test_about_preferences_settings() {
  const {
    tab,
    cleanup,
  ...
  click(settingsButton, "Opening the about:preferences Translations Settings");

  console.log(`!!! tab`, tab);
  await new Promise(resolve => setTimeout(resolve, 60 * 60 * 1000));
  let tree =
    tab.linkedBrowser.browsingContext.topChromeWindow.document.getElementById(
      "alwaysTranslateLanguagesTree"
    );
  //let remove = document.getElementById("removeAlwaysTranslateLanguage");
  //let removeAll = document.getElementById("removeAllAlwaysTranslateLanguages");

  is(tree.view.rowCount, 2, "The always-translate languages list has 2 items");
