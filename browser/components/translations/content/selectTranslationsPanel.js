...
var SelectTranslationsPanel = new (class {
  ...
  #updateConditionalUIEnabledState() {
    const { fromLanguage, toLanguage, fromVariant, toVariant } =
      this.#getSelectedLanguagePair();
    const {
      copyButton,
      textArea,
  ...
  async #requestTranslationsPort(languagePair) {
    console.log(`!!! requestTranslationsPort`, languagePair);
  ...
  async #createTranslator(languagePair) {
    ...
    const translator = await Translator.create(languagePair, {
