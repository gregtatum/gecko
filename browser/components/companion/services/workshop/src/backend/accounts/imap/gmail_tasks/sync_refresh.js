...
import { maxDecimal64Strings } from "shared/a64";
...
import {
  parseUI64 as parseGmailConvId,
  parseUI64 as parseGmailMsgId,
} from "shared/a64";
...
export default TaskDefiner.defineAtMostOnceTask([
  {
    ...
    async helped_execute(ctx, req) {
      ...
      let highestModseq = maxDecimal64Strings(
        mailboxInfo.highestModseq,
        syncState.modseq
      );
      for (let msg of messages) {
        ...
        highestModseq = maxDecimal64Strings(highestModseq, msg.modseq);
