...
var testHelper = {
  ...
  process(uid, cmd, args) {
    if (cmd === "create-mailapi") {
      ...
      try {
        var func;
        // XXX This whole file is likely dead code, but if trying to resurrect
        // any logic from in here, obviously we shouldn't use eval.
        //eval("func = " + args.func + ";");
...
deviceStorageTestHelper._bound_onChange = deviceStorageTestHelper._onChange.bind(
  deviceStorageTestHelper
);
