...
export var ParseError = makeError('WBXML.ParseError');
...
export function CompileCodepages(codepages) {
...
export function Element(ownerDocument, type, tag) {
...
export function EndTag(ownerDocument) {
  this.ownerDocument = ownerDocument;
}
EndTag.prototype = {
...
export function Text(ownerDocument, textContent) {
  this.ownerDocument = ownerDocument;
...
export function Extension(ownerDocument, subtype, index, value) {
  this.ownerDocument = ownerDocument;
...
export function ProcessingInstruction(ownerDocument) {
  this.ownerDocument = ownerDocument;
}
...
export function Opaque(ownerDocument, data) {
  this.ownerDocument = ownerDocument;
  this.data = data;
}
Opaque.prototype = {
...
export function Reader(data, codepages) {
 ...
 */
export function Writer(version, pid, charset, strings, dataType) {
