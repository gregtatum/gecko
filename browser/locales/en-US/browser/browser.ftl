...
sidebar-launcher-now = Insights
  .title = Insights
sidebar-launcher-bookmarks = Bookmarks
  .title = Bookmarks
sidebar-launcher-history = Recently visited
  .title = Recently visited
sidebar-launcher-syncedtabs = Tabs from other devices
  .title = Tabs from other devices
sidebar-launcher-home = Home
  .title = Home
sidebar-launcher-genaidebug = GenAI debug
  .title = GenAI debug
sidebar-launcher-downloads = Downloads
  .title = Downloads
sidebar-launcher-account = Profile
  .title = Profile
sidebar-launcher-side-view = Side View
  .title = Side View
sidebar-launcher-tabs-collapse = Collapse
  .title = Collapse
sidebar-launcher-tabs-expand = Expand
  .title = Expand
sidebar-launcher-tabs-pin = Keep expanded
  .title = Keep expanded
