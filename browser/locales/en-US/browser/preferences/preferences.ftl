...
preferences-simple-suggests-label-2 = { -firefox-suggest-brand-name }
preferences-simple-suggests-subtext-2 = { -firefox-suggest-brand-name } connects you to bookmarks, history, and cloud data
preferences-simple-search-suggestions-option-2 =
    .aria-label = Enable { -firefox-suggest-brand-name }
