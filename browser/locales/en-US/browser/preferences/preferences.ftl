...
preferences-simple-suggests-label = { -brand-short-name } Suggest
preferences-simple-suggests-subtext = { -brand-short-name } Suggest connects you to bookmarks, URL, and cloud data
