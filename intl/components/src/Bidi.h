...
class Bidi final {
 public:
   ...
   *
   * At the time of this writing, some places in Gecko code use a 1 in the most
   * significant bit to indicate that an embedding level has not been set. This
   * leads to an ambiguous understanding of what the most significant bit
   * actually means.
   */
