...
const _initFastTextModule = async function (wasmModule) {
  console.log("_initFastTextModule 1", loadFastTextModule);
  try {
    fastTextModule = await loadFastTextModule(wasmModule);
  } catch(e) {
    console.error(e);
  }
  console.log("_initFastTextModule 2");
  return true
}
...
const loadFastText = (wasmModule) => {
  console.log("loadFastText 1");
  _initFastTextModule(wasmModule).then((res) => {
    console.log("loadFastText 2");
    if (postRunFunc) {
      console.log("loadFastText 3");
      postRunFunc();
      console.log("loadFastText 4");
    }
  })
}
