    ...
    for task in tasks:
        ...
        if "tier" not in task or task["tier"] == "default":
            if task["test-platform"] in [
                ...
                "linux1804-64-pinebuild-qr/debug",
                "linux1804-64-shippable-qr/opt",
                "linux1804-64-pinebuild-qr/opt",
