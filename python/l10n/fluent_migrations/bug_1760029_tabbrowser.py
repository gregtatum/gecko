...
def migrate(ctx):
    ...
    ctx.add_transforms(
        ...
        [
            ...
            FTL.Message(
                id=FTL.Identifier("tabbrowser-confirm-browsewithcaret-title"),
                value=COPY(source, "browsewithcaret.checkWindowTitle"),
            ),
            FTL.Message(
                id=FTL.Identifier("tabbrowser-confirm-browsewithcaret-message"),
                value=COPY(source, "browsewithcaret.checkLabel"),
            ),
            FTL.Message(
                id=FTL.Identifier("tabbrowser-confirm-browsewithcaret-checkbox"),
            ...
            FTL.Message(
                id=FTL.Identifier("tabbrowser-mute-tab"),
                attributes=[
                    FTL.Attribute(
                        id=FTL.Identifier("label"),
            ...
            FTL.Message(
                id=FTL.Identifier("tabbrowser-unmute-tab"),
                attributes=[
                    FTL.Attribute(
                        id=FTL.Identifier("label"),
            ...
            FTL.Message(
                id=FTL.Identifier("tabbrowser-mute-selected-tabs"),
                attributes=[
                    FTL.Attribute(
                        id=FTL.Identifier("label"),
            ...
            FTL.Message(
                id=FTL.Identifier("tabbrowser-unmute-selected-tabs"),
                attributes=[
                    FTL.Attribute(
                        id=FTL.Identifier("label"),
